...
class MzmlReader:
    """Reader for mzML files backed by the optional ``mzmlpy`` package.

    Iteration works without an explicit context manager. A context manager
    keeps one handle open and is more efficient for repeated access.
    """
