...
spxtacular provides the spectrum processing and visualization behind the public [Spectra web application](https://spectra.tacular.dev/), an interactive spectrum viewer. In our laboratory, it is used to analyze and visualize output from the Sage search engine [@lazear2023sage] and, in ongoing unpublished work, in a post-translational modification motif ratio quantitation workflow for covalent protein painting data [@son2023cpp] studying transthyretin amyloidosis (ATTR); preliminary results from that study were presented at ASMS 2026 [@pankow2026asms]. spxtacular was also demonstrated alongside peptacular and related applications in an ASMS 2026 poster [@garrett2026asms].
